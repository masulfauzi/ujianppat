                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($nilai['skor'] <> "") : ?>
                                                    ...
                                                    <button data-id='<?= $nilai['id_nilai'] ?>' class='hapus btn btn-xs btn-danger'>Hitung Ulang</button>
                                                    <button onclick="window.location.href='hitungulangsemua.php?id=<?php echo $_GET['id'] ?>'" class=' btn btn-xs btn-danger'>Hitung Ulang Semua</button>
