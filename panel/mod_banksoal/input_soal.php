			...
			<div class='box box-solid'>
				<div class='box-header with-border bg-blue'>
					...
					<div class='box-tools pull-right btn-group'>
						...
						<button type='button' name='editor' onclick="window.location.href='<?php echo $homeurl ?>/panel/ubah_editor.php'" class='btn btn-sm btn-warning'><i class='fa fa-check'></i> Ubah Editor</button>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											<h4 class='box-title'>
												<a data-toggle='collapse' data-parent='#accordion' href='#collapseBobot' aria-expanded='false' class='collapsed'>
													KATEGORI SOAL
												</a>
											</h4>
										...
										<div id='collapseOne' class='panel-collapse collapse' aria-expanded='false' style='height: 0px;'>
											<div class='box-body'>
												<div class='form-group'>
													<textarea name='pilA' class='<?php echo cek_editor(); ?> pilihan form-control'><?= $soal['pilA'] ?></textarea>
												</div>
												<div class='form-group'>
												<?php
												if ($soal['fileA'] <> '') {
										...
										<div id='collapseB' class='panel-collapse collapse' aria-expanded='false' style='height: 0px;'>
											<div class='box-body'>
												<div class='form-group'>
													...
													<textarea name='pilB' class='" . cek_editor() . " pilihan form-control'>$soal[pilB]</textarea>
												</div>
												<div class='form-group'>";
												if ($soal['fileB'] <> '') {
													$audio = array('mp3', 'wav', 'ogg', 'MP3', 'WAV', 'OGG');
										...
										<div id='collapseC' class='panel-collapse collapse' aria-expanded='false' style='height: 0px;'>
											<div class='box-body'>
												<div class='form-group'>
													...
													<textarea name='pilC' class='" . cek_editor() . " pilihan form-control'>$soal[pilC]</textarea>
												</div>
												<div class='form-group'>";
												if ($soal['fileC'] <> '') {
													$audio = array('mp3', 'wav', 'ogg', 'MP3', 'WAV', 'OGG');
											...
											<div id='collapseD' class='panel-collapse collapse' aria-expanded='false' style='height: 0px;'>
												<div class='box-body'>
													<div class='form-group'>
														...
														<textarea name='pilD' class='" . cek_editor() . " pilihan form-control'>$soal[pilD]</textarea>
													</div>
													<div class='form-group'>";
													if ($soal['fileD'] <> '') {
														$audio = array('mp3', 'wav', 'ogg', 'MP3', 'WAV', 'OGG');
											...
											<div id='collapseE' class='panel-collapse collapse' aria-expanded='false' style='height: 0px;'>
												<div class='box-body'>
													<div class='form-group'>
														...
														<textarea name='pilE' class='" . cek_editor() . " pilihan form-control'>$soal[pilE]</textarea>
													</div>
													<div class='form-group'>";
													if ($soal['fileE'] <> '') {
														$audio = array('mp3', 'wav', 'ogg', 'MP3', 'WAV', 'OGG');
...
<script>
	tinymce.init({
		...
		toolbar: 'bold italic fontselect fontsizeselect | alignleft aligncenter alignright bullist numlist  backcolor forecolor | formula code | imagetools link image paste | code',
