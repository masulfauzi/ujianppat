...
// 	die("Aplikasi Ujian Sedang Dalam Perbaikan.");

//$browser = $_SERVER['HTTP_USER_AGENT'];
//$app = $_SERVER['HTTP_X_REQUESTED_WITH'];

//if($browser == 'exambro-ujian-smk2')
//{
	//echo "lolos";
//}
//else
//{
	//$pecah = explode(" ", $browser);
	
	//if($pecah[0] == 'exambro-smk2')
	//{

	//}
	//else
	//{
		//if($app == "com.muhammadrobi.EXAMBROPRO2022")
		//{

		//}
		//else{
			//if($app == "com.muhammadrobi.EXAMBROFREE2022")
			//{
...
<head>
	<title>(<?php echo SERVER ?>) Login | <?php echo $setting['aplikasi']; ?></title>
	<meta charset="UTF-8">
